...
CREATE TABLE "AzureConfig" (
    ...
    CONSTRAINT "AzureConfig_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "BragDoc" (
    ...
    "updatedAt" DATETIME NOT NULL,
    CONSTRAINT "BragDoc_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
